...
**Title**  
AgentGuard: when an AI agent is allowed to act, what guarantees the exact approved action is the one that executes?
...
5. Link to the showcase and reference kernel.
